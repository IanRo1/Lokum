  ...
  return (
    <div className="App">
      <Router>
        ...
        <Route path='/SavedSess' element={<SavedSess sessionName1={sessionName1}/>}/>
        <Route path='/SavedSess/Session' element={<Session names={names} sessionName={sessionName} setSessionName={setSessionName} sessionName1={sessionName1} setSessionName1={setSessionName1}/>}/>
